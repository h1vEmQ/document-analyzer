...
ИНСТРУКЦИЯ: Извлеки МИНИМУМ 8-12 ключевых моментов из документа. Чем больше важной информации, тем лучше. Не ограничивайся только основными темами - найди детали, цифры, даты, имена, конкретные факты.
